...
const icons = [
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/WilsonLe.2907/',
    icon: (props: any) => (
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/_wilsonle_/',
    icon: (props: any) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
  ...
  {
    name: 'Twitter',
    href: 'https://twitter.com/WilsonL71568706',
    icon: (props: any) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
  ...
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/wilsonle02/',
    icon: (props: any) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
